...
export const OriginalPortfolio = [
    {
        ...
        description: "This was my first project within the tech world. I was tasked with creating a portfolio website to showcase what I had learnt within HTML and CSS",
        techstack: "HTML (for structure) and CSS (for styling)",
        techtools: "Balsamiq (for wireframes), VS Code (for coding :p) and Netlify (for deployment to the world)",
...
export const TerminalApplication = [  
    {
        ...
        description: "This was my first real introduction to programming! Using the programming language of Ruby, I created a multiple choice questionaire, using programming concepts and Ruby Gems",
        techstack: "Ruby",
        techtools: "VS Code (for coding) and Ubuntu (or the Terminal) to run the application",
