            ...
            <p>During my adventure with CoderAcademy, I have worked on the following technologies, using various tools to help produce the projects seen in my portfolio</p>
                <div className="techstack-container">
                    <div class="techstackitems">
                        ...
                        <a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer"><img src="assets/icons8-visual-studio-code-2019-96.png" alt="vscode-logo" className="techstack-img" data-tip="Visual Studio Code"/></a>
                    </div>
                </div>
